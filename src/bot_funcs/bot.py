...
def create_group(channel_id, body):
...
def join_group(channel_id, body):
    ...
    try:
        message = dynamo_bot_funcs.join_group(channel_id, group_name, user)
...
def leave_group(channel_id, body):
    ...
    try:
        dynamo_bot_funcs.leave_group(channel_id, group_name, user)
